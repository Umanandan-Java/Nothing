<script>
    ...
    // --- Derived State ---
    $: commentsForDisplay = (() => {
    if (!selectedDraftId) return []; // Start with no comments if no draft is selected

    let filtered = allComments; // Start with all comments for the draft
    ...
    {#if selectedDraft}
        <div class="main-grid">
            ...
            <div class="card summary-card">
                <h2>Summary of comments received for the draft</h2>
